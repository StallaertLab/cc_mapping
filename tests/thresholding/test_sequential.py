...
class TestThresholdEntireDataset:
    ...
    def test_threshold_entire_dataset_success(self, adata_with_bimodal_dist):
        ...
        assert 'DNA_threshold' in seq_gmm.adata.uns['sequential_gmm_thresholding_events']
        
        # Check metadata
        op_data = seq_gmm.adata.uns['sequential_gmm_thresholding_events']['DNA_threshold']
...
class TestRefineLabelsWithGMM:
    ...
    def test_refine_labels_success(self, adata_with_bimodal_dist):
        ...
        # Check operation stored
        assert 'Plk1_refinement' in seq_gmm.adata.uns['sequential_gmm_thresholding_events']
        
        # Check metadata
        op_data = seq_gmm.adata.uns['sequential_gmm_thresholding_events']['Plk1_refinement']
...
class TestIntegration:
    ...
    def test_full_sequential_workflow(self, adata_with_bimodal_dist):
        ...
        assert 'Plk1_low_refinement' in adata_result.uns['sequential_gmm_thresholding_events']
        assert 'CyclinB_high_refinement' in adata_result.uns['sequential_gmm_thresholding_events']
        assert 'DNA_G2M_manual' in adata_result.uns['sequential_gmm_thresholding_events']
