"""Frozen copy of cc_mapping.core as of commit a9e6e74, before
random_forest_feature_selection became a wrapper around
cc_mapping.feature_selection.

tests/test_feature_selection.py uses it as the reference the selectors must
reproduce. The module-level warnings.simplefilter and np.seterr calls are left
out; they do not affect results. Delete this file together with the
